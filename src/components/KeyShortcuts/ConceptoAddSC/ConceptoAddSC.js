...
function ConceptoAddSC(props) {
    useHotkeys('shift+c', () => openModal())
...
//<button class="btn transparent" id="addcon" onClick={pruebaonclick}>AGREGAR UNIDAD</button>
    ...
    return (
        ...
        <Box  sx={style}>
            ...
            <i class="material-icons prefix">content_paste</i>
            <option value="Distribuible" disabled selected>
            CONCEPTO DISTRIBUIBLE
            </option>
            </select>
            :
            <select className="browser-default"  id="selectconsorcio5"  ref={tipodeconcepto} onChange={gettipoconcep}>
            ...
            <option value="No Distribuible" >No Distribuible</option>
            </select>
            }
