...
function ProvinceView(props) {
    ...
    Vacios
        ...
        <StyledTableRow >
            ...
            <StyledTableCell id="FilaPrincipal" align="right">PROVINCIA</StyledTableCell>
        ...
        {datoBusqueda
            ...
            .map((row, index) => (<>
                ...
                <StyledTableCell id="contenido" align="right" style={{borderBottom:"none"}}>
                    <Link to={`/provinces/${row.id}/localities`}><a class="btn-floating btn-large waves-effect waves-light transparent" ><i class="material-icons" onClick={display} id={row.id}>create</i></a></Link>
                    </StyledTableCell>

                <StyledTableCell id="contenido" align="right" style={{borderBottom:"none"}}>                               
                    <a class="btn-floating btn-large waves-effect waves-light red" ><i class="material-icons" onClick={display} >delete</i></a>
                    </StyledTableCell>
