        ...
        {datoBusqueda
            ...
            <StyledTableRow key={row.name}>
                ...
                <StyledTableCell id="contenido" align="right" style={{borderBottom:"none"}}>
                    <Link to={`/provinces/${id}/localities/${row.id}/neighborhoods`}><a class="btn-floating btn-large waves-effect waves-light transparent" ><i class="material-icons" onClick={display} id={row.id}>create</i></a></Link>
                    </StyledTableCell>
