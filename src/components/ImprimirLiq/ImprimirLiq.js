...
function done(){
    ...
    return (
        <>
        <div>
        <li><a class="prueba" onClick={openModal} style={{cursor:'pointer'}}> Imprimir Liquidaciones <i class="material-icons">keyboard_arrow_right</i></a></li>
        <Modal
        open={showModal}
        onClose={openModal}
        ...
        <Box  sx={style}>
            ...
            IMPRIMIR LIQUIDACIONES<div class="input-field col s10" id="FechaAltaGastos">
            ...
            <a class="waves-effect waves-light btn" id="botondecambio1"  onClick={wichone}>consorcio</a>
            <a class="waves-effect waves-light btn" onClick={wichone2}><i class="material-icons">chevron_right</i></a>
            </div>
            
            <select className="browser-default" id="selectconsorcio7asdasd" ref={valorcons} onClick={getConsorcio} onChange={getUnit}> 
            ...
            <div class="input-field col s10" id="periodoaliq2ssa">
            ...
            <a class="waves-effect waves-light btn" id="botonGENERARLIQ">Generar Liquidacion</a>
            </>
            :
                <>
            <Typography id="modal-modal-description" >
            ...
            <a class="waves-effect waves-light btn" id="botoncambio2" onClick={wichone2}>unidad</a>
            </div>
            ...
            <select className="browser-default" id="selectconsorcio7asdasd2" ref={valorcons} onClick={getConsorcio} onChange={getUnit}> 
            <option value="" disabled selected >
            UNIDADES
            </option>
            {consorcios.map((option) => (
