...
//<button class="btn transparent" id="addcon" onClick={pruebaonclick}>AGREGAR UNIDAD</button>
    ...
    function postLocalities(){
        ...
        var raw = JSON.stringify({
            ...
            "postalCode": codigoPostal.current.value
        });
        ...
        fetch(`http://localhost:4000/provinces/${id}/localities`, requestOptions)
    ...
    return (
        <>
        <div>
        <Button onClick={openModal} id="boton">AGREGAR LOCALIDAD</Button>
        <Modal
        open={showModal}
        onClose={openModal}
        ...
        <Box  sx={style}>
            ...
            <div class="input-field col s10">
            <i class="material-icons prefix">class</i>
            <input id="Denominacion" type="text" class="validate" ref={codigoPostal}/>
            <label for="Denominacion">Codigo Postal</label>
            </div>
            <button class="btn waves-effect waves-light" type="submit" name="action" id="boton1" onClick={postLocalities} >GUARDAR
            </button>
