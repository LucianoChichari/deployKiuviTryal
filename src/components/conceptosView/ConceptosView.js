...
function ConceptosViews(props) {
    ...
    Vacios
        ...
        <StyledTableRow >
            <StyledTableCell id="FilaPrincipal" align="right">Denominacion</StyledTableCell>
            <StyledTableCell id="FilaPrincipal" align="right">Prioridad</StyledTableCell>
            <StyledTableCell id="FilaPrincipal" align="right">Origen</StyledTableCell>
            <StyledTableCell id="FilaPrincipal" align="right">Coeficiente</StyledTableCell>
            <StyledTableCell id="FilaPrincipal" align="right">Tipo</StyledTableCell>
            <StyledTableCell id="FilaPrincipal" align="right">Editar</StyledTableCell>
            <StyledTableCell id="FilaPrincipal" align="right">Eliminar</StyledTableCell>
        </StyledTableRow>
        </TableHead>
        ...
        {datoBusqueda
            ...
            .map((row, index) => (<>
                ...
                <StyledTableCell id="contenido" align="right" style={{borderBottom:"none"}}>
                    <Link to={`/Unidades/${row.id}`}><a class="btn-floating btn-large waves-effect waves-light transparent" ><i class="material-icons" onClick={display} id={row.id}>create</i></a></Link>
                    </StyledTableCell>
